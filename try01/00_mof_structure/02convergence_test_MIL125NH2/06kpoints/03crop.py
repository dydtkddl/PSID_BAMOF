...
def main():
    ...
    ax1.set_ylabel("Total Energy (kj/mol) Compared to 1 1 1", color=color_energy)
    ax1.plot(sweep_values, [ (x - energies[0] ) * 2600 for x in  energies] , color=color_energy, marker="o", label="Total Energy")
